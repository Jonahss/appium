  ...
  var doFind = function (findCb) {
    ...
    switch (strategy) {
      ...
      case "-ios_uiautomation":
        ...
        //fake out, let's pretend that -ios_uiautomation works, but really it just calls by type
...
iOSController.findElementOrElements = function (strategy, selector, ctx, many, cb) {
  if (deviceCommon.checkValidLocStrat(strategy, this.curWindowHandle, cb)) {
